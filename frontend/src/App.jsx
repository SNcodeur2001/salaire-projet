...
import EmployeDashboard from "./pages/employe/dashboard.jsx";
import EmployeAttendance from "./pages/employe/attendance.jsx";
...
const AppContent = () => {
  ...
  return (
    <Routes>
      ...
      />
      <Route
        path="/caissier/attendance"
        element={
          <ProtectedRoute allowedRoles={["EMPLOYE", "EMPLOYEE"]}>
            <DashboardLayout
              userRole="caissier"
